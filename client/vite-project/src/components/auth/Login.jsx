  ...
  return (
       <AuthContext.Consumer>
        ...
        <form className="form" onSubmit={(e)=>{
          ...
          <input type="email" className="input" placeholder="Email" name='email' value={input.email}
              onChange={(event) => handleInput(event)}/>
          <input type="password" className="input" placeholder="Password" name='password'  value={input.password}
              onChange={(event) => handleInput(event)}/>
        ...
        <p className="sign-up-label">
          Don't have an account?<Link to='/register'><span className="sign-up-link">Sign up</span></Link>
        </p>
