  ...
  const getData = async () => {
    if (selectTag) {
      const response = await axios.post(
        "http://localhost:4000/api/v1/searchblog",
        { tags: selectTag },
        { withCredentials: true }
      );
      console.log(response);
      ...
      <FollowCard className=" bg-gray-700">
        <Title>
          ...
          <img
            ...
            src="https://raw.githubusercontent.com/CleverProgrammers/cp-linkedin-clone/f014d361d787029f15ea0f0f78c053d8c214f138/public/images/feed-icon.svg"
            alt=""
          />
        </Title>
            ...
            tags.map((index, val) => {
              ...
              return (
                <div
                  ...
                  className={`${
                    click === index.label
                      ? "bg-blue-800 text-yellow-100"
                      : "bg-transparent text-yellow-200"
                  } rounded-full px-2 gap-2 py-1 border-2 shadow-lg mt-4 cursor-pointer hover: bg-slate-900`}
                  onClick={() => {
        ...
        <Recommendation className=" mt-6">
          ...
          <img
            src="https://raw.githubusercontent.com/CleverProgrammers/cp-linkedin-clone/f014d361d787029f15ea0f0f78c053d8c214f138/public/images/right-icon.svg"
            alt=""
          />
        </Recommendation>
      </FollowCard>
