...
const getLocalData = () => {
  const retrivedData = localStorage.getItem("updateblogDescription");
...
export default function BlogUpdate() {
    ...
    const getData=async()=>{
      const response=await axios.post("http://localhost:4000/api/v1/updateblog",{})
    }
    ...
    const setLocally = () => {
      ...
      localStorage.setItem("updateblogDescription", JSON.stringify(data));
    };
    useEffect(() => {
      setLocally();
    }, [description]);
